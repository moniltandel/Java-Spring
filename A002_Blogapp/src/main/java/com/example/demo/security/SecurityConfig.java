...
//	}
	...
	public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
		...
		.requestMatchers(HttpMethod.GET,"/blog/**")
		.hasRole("USER")
		.requestMatchers(HttpMethod.POST,"/blog/**")
		.hasRole("USER")
		.requestMatchers(HttpMethod.PUT,"/blog/**")
		.hasRole("USER")
		.requestMatchers(HttpMethod.DELETE,"/blog/**")
		.hasRole("USER")
		
		// -----------------  Blog Category -----------------
		.requestMatchers(HttpMethod.GET,"/blogcategories/**")
		.hasAnyRole("USER","ADMIN")
		.requestMatchers(HttpMethod.POST,"/blogcategories/**")
		.hasRole("ADMIN")
		.requestMatchers(HttpMethod.PUT,"/blogcategories/**")
		.hasRole("ADMIN")
		.requestMatchers(HttpMethod.DELETE,"/blogcategories/**")
		.hasRole("ADMIN")
