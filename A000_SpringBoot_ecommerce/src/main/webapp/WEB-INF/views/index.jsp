            ...
            <c:forEach var="i" items="${products }">
              <div class="product__item">
                <div class="product__banner">
                  <a href="details?id=${i.getId() }" class="product__images">
                    <img
                      src="../product_img/${i.getImage() }"
                      alt=""
                ...
                <div class="product__content">
                  <span class="product__category">${i.getCategory().getName() }</span>
                  <a href="details.html">
                    <h3 class="product__title">${i.getName() } </h3>
                  </a>
                  ...
                  <div class="product__price flex">
                    <span class="new__price">${i.getPrice() } ₹</span>
